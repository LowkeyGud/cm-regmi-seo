    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <main className="mx-auto max-w-3xl px-6 py-24">
        ...
        <div className="prose prose-invert max-w-none text-muted-foreground space-y-6">
          ...
          <p>
            Welcome to the professional portfolio and technical documentation hub of CM Regmi. 
            We respect your privacy and are committed to protecting your personal data.
          </p>

          <h2 className="text-2xl font-bold text-foreground">2. Cookies and Web Beacons</h2>
          <p>
            This site uses cookies to store information, such as your personal preferences when you visit our site. 
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Alternatively, you can opt out of a third-party vendor's use of cookies for personalized advertising by visiting <a href="https://youradchoices.com/" target="_blank" rel="noreferrer" className="text-primary hover:underline">www.aboutads.info</a>.
            </li>
          </ul>

          <h2 className="text-2xl font-bold text-foreground">4. Contact Us</h2>
          <p>
            If you have any questions about this Privacy Policy, please contact us at <a href="mailto:learntechcontact@gmaill.com" className="text-primary hover:underline">learntechcontact@gmaill.com</a>.
          </p>
        </div>
      </main>
      <SiteFooter />
